...
type PageInfo struct {
	...
	PSize uint32 `protobuf:"varint,2,opt,name=pSize,proto3" json:"pSize,omitempty"` //条数
}
...
type UserListResponse struct {
	...
	Total uint32              `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` //总条数
	Data  []*UserInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`    //用户信息
}
...
type UserInfoResponse struct {
	...
	Gender   uint32 `protobuf:"varint,6,opt,name=gender,proto3" json:"gender,omitempty"`     //0男；1女
	Role     uint32 `protobuf:"varint,7,opt,name=role,proto3" json:"role,omitempty"`         // 1普通用户；2管理员用户
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x32, 0xb8, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x0b, 0x47,
	...
	0x64, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x11, 0x2e, 0x55, 0x73, 0x65,
...
var file_user_proto_depIdxs = []int32{
	...
	8, // 11: User.UpdateUser:output_type -> google.protobuf.Empty
	1, // 12: User.CheckPassword:output_type -> UserListResponse
...
type UserClient interface {
	...
	CheckPassword(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*UserListResponse, error)
}
...
func (c *userClient) CheckPassword(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*UserListResponse, error) {
	out := new(UserListResponse)
...
type UserServer interface {
	...
	CheckPassword(context.Context, *PasswordCheckInfo) (*UserListResponse, error)
}
...
func (*UnimplementedUserServer) CheckPassword(context.Context, *PasswordCheckInfo) (*UserListResponse, error) {
